...
This is the code for "A Guide to Building Your First Decentralized Application" 

## Overview

This is the code for a guide on how to build your first decentralized application. 
...
```
EngineerRajeev:~/hello_world_voting$ node
> Web3 = require('web3')
